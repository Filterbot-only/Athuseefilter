...
API_ID = int(environ.get('API_ID', '28124916'))
API_HASH = environ.get('API_HASH', '333e5539da1f4e87dd12227a7304125d')
BOT_TOKEN = environ.get('BOT_TOKEN', "6859698464:AAHrK9sQ1leu_aBIQjkhUZ-fffmJrlvo2F8")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002037491541').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vairamdonpre827:vairamdonpre82710@cluster0.s7jz2d9.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "mrmalik_offl")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+tPcOATDcE_cxMzZl')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001887648644'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+tPcOATDcE_cxMzZl')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002037491541')).split()]
